                    ...
                    <div class="padding">
                        ...
                        <div>
                            ...
                            <div class="social-links">
                                <ul>
                                    <li><a href="<?php echo esc_url($store_info['facebook_url']); ?>" aria-label="Link to Zouzou Hair's Facebook account"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
                                    ...
                                    <li><a href="<?php echo esc_url($store_info['instagram_url']); ?>" aria-label="Link to Zouzou Hair's Instagram account"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
                                    ...
                                    <li><a href="<?php echo esc_url($store_info['tiktok_url']); ?>" aria-label="Link to Zouzou Hair's TikTok account"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
