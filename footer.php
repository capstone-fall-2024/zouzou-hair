...
<footer id="colophon" class="site-footer">
	<div class="container footer-grid">
			...
			<div class="grid-2">
				<div class="connect-with-us">
					...
					<div class="social-links">
						<ul>
							<li><a href="<?php echo esc_url($store_info['facebook_url']); ?>" target="_blank" aria-label="Link to Zouzou Hair's Facebook account"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
							...
							<li><a href="<?php echo esc_url($store_info['instagram_url']); ?>" target="_blank" aria-label="Link to Zouzou Hair's Instagram account"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
							...
							<li><a href="<?php echo esc_url($store_info['tiktok_url']); ?>" target="_blank" aria-label="Link to Zouzou Hair's TikTok account"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
			...
			<div class="grid-4"><iframe src="<?php echo esc_url($store_info['map_url']); ?>" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" aria-label="map" aria-description="Google map of Zouzou Hair's location"></iframe></div>
	</div>
</footer><!-- #colophon -->
</div><!-- #page -->
